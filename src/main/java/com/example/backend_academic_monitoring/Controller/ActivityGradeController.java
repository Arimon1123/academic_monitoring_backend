...
//    @GetMapping()
//    public ResponseEntity<ResponseDTO<List<ActivityGradeEntity>>> getGradesByStudentIdAndAssignationId(@RequestParam Integer studentId, @RequestParam Integer assignationId, @RequestParam Integer bimester){
//        try {
//            return ResponseEntity.ok(new ResponseDTO<>(activityGradeService.getGradesByStudentIdAndAssignationId(studentId, assignationId, bimester), "Grades found successfully", 200));
//        } catch (Exception e) {
//            return ResponseEntity.internalServerError().body(new ResponseDTO<>(null, "Error finding grades", 500));
//        }
//    }
